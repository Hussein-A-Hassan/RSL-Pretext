...
# Important if we set consistent=False ---> we have to set seq_len>0
# I think if it is consistent=False then more than one random crop will happen at the same video
# The seq_len is the length of each random crop
...
# Important if we set consistent=False ---> we have to set seq_len>0
# I think if it is consistent=False then more than one random flip will happen at the same video
# The seq_len is the length of each random flip : Try seq_len=10 or 30
